...
//     localStorage.setItem("[i]", inputValue[i]);
//     hoursInput.setAttribute("placeholder","");
//    }
...
for (var i = 0; i<hours.length; i++){
    ...
    // for (var i=0; i<hours.length; i++){
    //     if (hoursInput[i]!=null){hoursInput[i].setAttribute("placeholder",storedInput[i])}
    // }
if (stored9AM!=null){
    nineAMInput.setAttribute("placeholder",stored9AM);}
...
//     for (var i = 0; i<hours.length; i++){
//         // nineAMInput.setAttribute("placeholder",stored9AM);
//         hoursInput[i].setAttribute("placeholder",storedInput[i])
    
//     }
//     }
function check(){
if (stored9AM == null || stored9AM == "null"){
